...
def t000002012_x5(val1=_, actionbutton1=_):
    ...
    while True:
        ...
        """State 5"""
        SetBuddySpawnPoint()
        call = t000002012_x12(actionbutton1=actionbutton1, flag1=6001, flag2=6000, flag3=6000, flag4=6000, flag5=6000,
                              flag6=6000)
        def WhilePaused():
            GiveSpEffectToPlayer(84)
        if call.Done():
...
def t000002012_x10():
    ...
    if GetBuddyStoneBuddyID() == 801400:
        """State 3"""
        # goods:11004:Cerulean Crystal Tear
        assert t000002012_x9(z1=GetBuddyStoneSpEffect(GetBuddyStoneBuddyID()), goods1=11004, action1=13041100)
    elif GetBuddyStoneBuddyID() == 801500:
        """State 4"""
        assert t000002012_x9(z1=GetBuddyStoneSpEffect(GetBuddyStoneBuddyID()), goods1=11100, action1=13041110)
    elif GetBuddyStoneBuddyID() == 802400:
        """State 5"""
        assert t000002012_x9(z1=GetBuddyStoneSpEffect(GetBuddyStoneBuddyID()), goods1=11101, action1=13041120)
    elif GetBuddyStoneBuddyID() == 802500:
        """State 6"""
        assert t000002012_x9(z1=GetBuddyStoneSpEffect(GetBuddyStoneBuddyID()), goods1=11102, action1=13041130)
    elif GetBuddyStoneBuddyID() == 802600:
        """State 7"""
        assert t000002012_x9(z1=GetBuddyStoneSpEffect(GetBuddyStoneBuddyID()), goods1=11103, action1=13041140)
    else:
        """State 2"""
        pass
    """State 8"""
